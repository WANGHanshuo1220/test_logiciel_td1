...
class test(unittest.TestCase):
    def test_cal_moyenne(self):
        self.assertEqual(ex1.cal_moyenne((1, 2, 3, 4, 5)), 15)
        self.assertEqual(ex1.cal_moyenne((10, 2, 3, 1)), 16)
        self.assertEqual(ex1.cal_moyenne((1, 2, 3, 4)), 10)
        self.assertEqual(ex1.cal_moyenne((1, 0, 0, 0)), 1)
    ...
    def test_is_geometrique2(self):
        ...
        self.assertEqual(ex1.is_geometrique2((1, 0, 0, 0)), False)
    ...
    def test_is_arithmetique2(self):
        ...
        self.assertEqual(ex1.is_arithmetique2((1, 0, 0, 0)), False)
